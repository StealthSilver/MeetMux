...
import DottedGlowBackground from "@/app/components/ui/DottedBackground";

export const Cta = () => {
  return (
    <section className="relative mb-10 flex flex-col items-center justify-center px-4 sm:px-6 overflow-hidden text-center bg-[var(--color-background)] text-[var(--color-foreground)]">
      <DottedGlowBackground
        ...
        gap={6}
        radius={1.2}
        colorLightVar="--color-neutral-900"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-3xl py-14 sm:py-20">
        <motion.h2
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-3xl sm:text-5xl md:text-6xl font-primary font-bold leading-tight"
        >
          Start Building <br />
          <span className="relative inline-block bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 bg-[length:200%_200%] bg-clip-text text-transparent transition-all duration-500 ease-out hover:animate-gradient-move">
            Connections
          </span>{" "}
          Today
        </motion.h2>
        ...
        <motion.p
          ...
          className="mt-6 sm:mt-8 text-base sm:text-lg md:text-xl font-secondary text-gray-700 dark:text-gray-300 max-w-xl"
        >
          Join thousands of people already discovering amazing activities and
          building meaningful relationships with MeetMux.
        </motion.p>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-10 w-full max-w-2xl"
        >
          <Link
